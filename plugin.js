...
export function All(input) {
    return wails.Plugin("example_plugin", "All", input);
}
...
export function MD5(input) {
    return wails.Plugin("example_plugin", "MD5", input);
}
...
export function SHA1(input) {
    return wails.Plugin("example_plugin", "SHA1", input);
}
...
export function SHA256(input) {
    return wails.Plugin("example_plugin", "SHA256", input);
}